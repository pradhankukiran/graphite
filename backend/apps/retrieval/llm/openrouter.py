"""OpenRouter LLM provider — unified gateway to many model providers."""
...
class OpenRouterProvider(BaseLLMProvider):
    """OpenRouter unified API via OpenAI-compatible interface."""
    ...
    def _get_client(self) -> AsyncOpenAI:
        ...
        OpenRouter requires an ``HTTP-Referer`` header for attribution and
        an ``X-Title`` header to identify the application.
        """
